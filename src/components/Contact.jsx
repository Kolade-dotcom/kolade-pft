  ...
  return (
    <section id="contact" className={"section"}>
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          ...
          <div className={"mt-auto flex items-center gap-2"}>
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                target={"_blank"}
                className={
                  "reveal-up grid h-12 w-12 place-items-center rounded-lg ring-2 ring-inset ring-zinc-50/5 transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                }
              >
                {icon}
              </a>
        ...
        <form
          action={"https://getform.io/f/blllrnkb"}
          method={"POST"}
          className={"xl:pl-10 2xl:pl-20"}
        >
          <div className={"mg:grid md:grid-cols-2 md:items-center md:gap-2"}>
            <div className={"mb-4"}>
          ...
          <button
            type="submit"
            className={
              "btn btn-primary reveal-up w-full justify-center [&]:max-w-full"
            }
          >
            Submit
          </button>
